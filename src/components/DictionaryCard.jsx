    ...
    <div className={styles.outer}>
      ...
      >
        ...
        <div className={styles.header}>
          ...
          <div className={styles.wordBlock}>
            ...
            <div className={styles.phonetic}>
              <span className={styles.phoneticText}>/sɛˈlɑːm/</span>
              <button className={styles.listenBtn} onClick={speak} aria-label="Hear pronunciation">
        ...
        <div className={styles.origins}>
          {[
            { label: 'Amharic',      color: 'green'  },
            { label: 'Tigrinya',     color: 'yellow' },
            { label: "Ge'ez",        color: 'red'    },
            { label: 'S-L-M Root',   color: 'neutral'},
          ].map(o => (
            <span key={o.label} className={`${styles.pill} ${styles[o.color]}`}>
              {o.label}
            </span>
          ))}
        </div>
        ...
        <ol className={styles.defList}>
          <li>
            ...
            <p className={styles.defText}>
              <em>"Hello,"</em> <em>"hi,"</em> or <em>"peace be upon you"</em> — the everyday salutation
              across Ethiopia and Eritrea, said to friends, family, and strangers alike.
            </p>
          ...
          <li>
            ...
            <p className={styles.defText}>
              <em>Peace, wholeness, harmony.</em> A state of inner and communal well-being,
          ...
          <li>
            ...
            <p className={styles.defText}>
              A parting blessing — <em>"go in peace"</em> — wishing safety upon departure.
            </p>
        ...
        <div className={styles.etymRow}>
          ...
          <p className={styles.etymText}>
            From <strong>Ge'ez</strong> via the Proto-Semitic root <em>*šalām</em> (to be safe, whole) —
            cognate with Arabic <span className={styles.script}>سَلَام</span> (Salām)
            and Hebrew <span className={styles.script}>שָׁלוֹם</span> (Shalom).
          </p>
        </div>
